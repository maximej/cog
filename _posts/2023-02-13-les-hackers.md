...
![styled-image](/assets/images/hacking/chappe.png "Chappe"){: .align-center style="width: 560;"}
...
![styled-image](/assets/images/hacking/nevil.jpg "Nevil"){: .align-center "}
...
![styled-image](/assets/images/hacking/phrack.jpeg "Phrack"){: .align-center "}
*No threats detected*
{: .align-caption}
...
![styled-image](/assets/images/hacking/logicielslibres1.jpg "Libr"){: .align-center "}
...
De ce désir de faire pour le plaisir de créer naît la pratique du Hackathon : un concours de créateurs numériques, limité dans le temps, qui doit répondre à des contraintes précises. Les thèmes sont variés, et l’objectif est toujours de s'entraîner à la résolution de problèmes, comme au [Stupid Hackathon](http://www.stupidhackathon.com/). On fait aussi des[Game Jam](/ggj2023/), concours créatif spécialisé dans les jeux, numériques ou non, comme **la [Global Game Jam](https://globalgamejam.org/2023/jam-sites/game-jam-de-pantin-le-cog), qui réunit des dizaines de milliers de participants** chaque année venant d’une centaine de pays, qui vont coder des jeux tous partagés en creative commons.
...
![styled-image](/assets/images/hacking/banc.png "Banc"){: .align-center "}
...
![styled-image](/assets/images/hacking/d4e.jpg "D4e"){: .align-center "}
...
: [Johnny Mnemonic](https://fr.wikipedia.org/wiki/Johnny_Mnemonic_(film)), de Robert Longo, 1995, d’après une nouvelle de [William Gibson](https://fr.wikipedia.org/wiki/William_Gibson) de 1986
