...
Découvre de nouveaux dessins de pirates par Vincent Tellier sur sa page : [Instagram ](https://www.instagram.com/vinzjb/){: .btn .btn--warning}
{: .notice} 
{: style="text-align: center;"}

<iframe src="https://www.instagram.com/vinzjb/embed" width="600" height="580" frameborder="0"> </iframe>

## Une chasse au trésor de pirates
...
![styled-image](/assets/images/jeux/BoucaniersKlaudiaEpinal23_5.jpg "Boucaniers"){: .align-center style="width: 600;"}
...
![styled-image](/assets/images/jeux/BoucaniersKlaudiaEpinal23_8.jpg "Boucaniers"){: .align-center style="width: 600;"}
...
19 tuiles. 10 figurines de bateaux. 2 figurines de navires des compagnies des Indes. 9 cartes indices. 10 Feuilles bateaux. 29 cartes Boucaniers et 6 affranchis. 20 pièces de 1 et 20 pièces de 5. Jetons canne à sucre, esclaves et rhum, améliorations, dégâts et lettres de marque. 5 disques de déplacement.

![styled-image](/assets/images/jeux/BoucaniersKlaudiaEpinal23_3.jpg "Boucaniers"){: .align-center style="width: 600;"}
*10 Feuilles bateaux avec un descriptif technique et historique au dos*
{: .align-caption}

![styled-image](/assets/images/jeux/BoucaniersKlaudiaEpinal23_4.jpg "Boucaniers"){: .align-center style="width: 600;"}
...
♦ Féticheur : se recrute exclusivement au Maître Vaudou et permet, une fois embarqué, de recruter
des boucaniers sur cette île (avant le joueur accosté à l’île aux Cornichons) et même depuis la pioche.
...
♦ Commandante : ACTION, déplace le navire d’une distance de 1 dans la direction voulue à la fin du
tour, pour 1 pièce.
...
♦ Mutine : regarde le compas de navigation d’un autre joueur avant de calibrer
le sien lorsque la coque de son propre navire est à 1 ou 2.
...
♦ Canotier : ACTION, pour 1 pièce, aborde un ou plusieurs navires sur un point aligné à 1 ou 2 de
distance du choix du joueur au prochain tour, s’il n’y a pas déjà abordage au contact.
♦ Tortionnaire : vole les indices à l’abordage et récupère les fragments des boucaniers ennemis tués.
♦ Negmarron : les affranchis restent dans l’équipage après un accostage et peuvent être sacrifiés
chez les cannibales.
♦ Timonier : ACTION, pour 1 pièce, permet de choisir le déplacement du navire après les autres
joueurs au prochain tour (ainsi après la Mutine).
